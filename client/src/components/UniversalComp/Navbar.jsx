...
const Navbar = (props) => {
  return (
    <div style={{backgroundColor:props.color}} className='bg-{props} animate__animated animate__slideInDown h-[15vh] flex justify-between items-center px-14 text-white font-[Helvetica] relative z-20'>
