        ...
        <div className='flex gap-10 py-16 justify-center font-[Helvetica] relative'>
            ...
            <div className="mid flex flex-col gap-6 pt-1">
                ...
                <div className="paras flex flex-col gap-10">
                    <div className="para1 text-2xl w-[400px]">Organise dry and wet wastes into separate components</div>
                    <div className="funs">
                        <div className="para2 text-2xl pb-3">Cut out plastics for recycling</div>
                        <button className='bg-yellow-400 py-2 px-6 rounded-md text-xl'>Know How</button>
                    </div>
                </div>
            </div>
            <div className="image relative">
                <img className='relative w-[450px] h-[450px]' src="src/assets/recycle-removebg-preview.png" alt="" />
            </div>
        </div>
    )
}
