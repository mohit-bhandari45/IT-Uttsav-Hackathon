...
const Card1 = () => {
    return (
        <div className='flex gap-10 py-16 justify-center font-[Helvetica] relative'>
            <div className="num bg-black w-[75px] h-[75px] rounded-full text-white flex justify-center items-center text-2xl relative z-10">1</div>
            <div className="mid flex flex-col gap-6 pt-2">
            ...
            <div className="image relative w-[400px] h-[400px]">
                <img className='relative' src="src/assets/recycle-removebg-preview.png" alt="" />
            </div>
        </div>
    )
}
