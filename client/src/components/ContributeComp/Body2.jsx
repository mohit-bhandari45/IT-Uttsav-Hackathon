...
const Body2 = (props) => {
    ...
    const handlechange = (e) => {
        ...
        // value.setdetails({...value.details.items,[e.target.name]:e.target.value})
    }
    const handlechange2=(e) => {
        // value.setdetails({...value.details.items,[e.target.name]:files})
    }
                    ...
                    <form action="" className='flex flex-col justify-center gap-7'>
                        ...
                        <div className="about flex flex-col gap-3">
                            ...
                            <div className="inputs flex flex-col gap-4">
                                ...
                                <input className='px-3 py-3 border-[2px] border-[#37A896] w-[300px] rounded-md' type="text" placeholder='Type of items' />
                            </div>
                        </div>
                        ...
                        <div className="image w-[330px] py-2 border-dashed border-[2px] border-[#37A896] rounded-md text-xl px-3 text-gray-400">
                            <div className="heading">
                                <input onChange={handlechange2} name="file" className='block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400' type="file" placeholder='Attach Image' id="" />
                            </div>
                        </div>
                        ...
                        <div className="button">
                            <button onClick={() => props.settrigger(3)} className='ml-[360px] text-white font-bold bg-[#37A896] rounded-md px-7 py-2 text-xl'>Next</button>
                        </div>
                    </form>
                </div>
            </div>
